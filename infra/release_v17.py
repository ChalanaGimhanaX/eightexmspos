...
"""
release_v17.py:
Comprehensive release builder and deployment script for Enightx POS v1.0.17:
...
7. Deploys updated API code to /srv/enightx/production/releases/v1.0.17 and restarts systemd service
...
def main():
    ...
    # 9. Deploy API code to /srv/enightx/production/releases/v1.0.17
    target_api_rel = "/srv/enightx/production/releases/v1.0.17"
...
"""
    ...
    print("\n✅ Enightx POS v1.0.17 successfully built and deployed to production!")
